...
export function getMeta() {
    ...
    return {
        name: 'root',
        component: '::div',
        className: 'ttk-edf-app-portal-hor',
        children: [
            {
                name: 'header',
                component: 'Layout',
                className: 'ttk-edf-app-portal-hor-header',
                children: [
                    {
                        name: 'left',
                        component: 'Layout',
                        className: 'ttk-edf-app-portal-hor-header-left',
                        // _visible: '{{data.isShowMenu}}',
                        children: [{
                            name: 'logo',
                            component: '::img',
                            className: 'ttk-edf-app-portal-hor-header-left-logo',
                            src: '{{$getLogo()}}'
                        }, {
                            name: 'siteName',
                            component: '::h2',
                        ...
                        name: 'right',
                        component: 'Layout',
                        className: 'ttk-edf-app-portal-hor-header-right',
                        children: [{
                            name: 'common',
                            component: 'Popover',
                            ...
                            className: 'ttk-edf-app-portal-hor-header-right-menu',
                            ...
                            content: [
                                    ...
                                    children: [
                                        {
                                            ...
                                            className: 'ttk-edf-app-portal-hor-header-right-menu-item1',
                                ...
                                },
                                {
                                    ...
                                    children: [
                                        {
                                            name: 'org3',
                                            className: 'ttk-edf-app-portal-hor-header-right-org-popover-icon',
                                            component: 'Button',
                                            ...
                                            children: {
                                                ...
                                                children: [{
                                                    ...
                                                    className: 'ttk-edf-app-portal-hor-header-right-org-popover-icon-title'
                                                }, {
                                                    name: 'item',
                                                    component: '::span',
                            ...
                            name: 'center',
                            component: 'Layout',
                            className: 'ttk-edf-app-portal-hor-header-center',
                            children: [
                                {
                                    name: 'left',
                                    component: 'Layout',
                                    style: "{{data.width ? {width: '200px'}	: {width: '100px'}}}",
                                    className: 'ttk-edf-app-portal-hor-content-left',
                                    _visible: '{{data.isShowMenu}}',
                                    trigger: 'click',
                                    children: [{
                                        name: 'leftMenu',
                        ...
                        },
                        {
                            name: 'rightDiv',
                            component: '::div',
                            className: 'ttk-edf-app-portal-hor-search-rightDiv',
                            children: [{
                                name: 'topSearch1',
                                _visible: '{{data.headCtrl}}',
                                component: '::span',
                                className: 'ttk-edf-app-portal-hor-header-right-headerSearch',
                                ...
                                children: [{
                                    ...
                                    fontFamily: 'edficon',
                                    style: { fontSize: '22px', verticalAlign: 'middle', },
                                    className: 'ttk-edf-app-portal-hor-header-right-help-icon-popover',
                                ...
                                children: [{
                                    ...
                                    component: '::span',
                                    className: 'headBarBtn',
                                    children: '{{data.isTabsStyle ? "单页" : "多页"}}',
                                }]
                            }, {
                                name: 'fullScreen',
                                component: '::span',
                                ...
                                children: {
                                    ...
                                    className: '{{data.animation == "in" ? "ttk-edf-app-portal-hor-header-right-help-popover animated slideInDown" : "ttk-edf-app-portal-hor-header-right-help-popover animated slideOutDown"}}',
                                    // className: 'ttk-edf-app-portal-hor-header-right-help-popover',
                                    children: [{
                                        name: 'shade1',
                                        onMouseOver: '{{$hidePanel}}',
                                        className: 'ttk-edf-app-portal-hor-header-right-help-popover-shade',
                                        component: '::div',
                                        onClick: '{{$hidePanel}}'
                                    }, {
                                        name: 'shade2',
                                        className: 'ttk-edf-app-portal-hor-header-right-help-popover-content',
                                        component: '::div',
                                        ...
                                        children: [{
                                            ...
                                            name: 'titleIcon',
                                            component: '::div',
                                            className: 'ttk-edf-app-portal-hor-header-right-help-popover-titleIcon',
                                            children: [{
                                                name: 'helpIcon',
                                                component: 'Icon',
                                                bordered: false,
                                                ...
                                                className: 'ttk-edf-app-portal-hor-header-right-help-popover-icon',
                                                type: 'bangzhuzhongxin'
                                            }, {
                                                name: 'helpTitle1',
                                                component: '::span',
                                                bordered: false,
                                                className: 'ttk-edf-app-portal-hor-header-right-help-popover-title1',
                                                children: '帮助中心'
                                            }]
                                        }, */{
                                            name: 'Search',
                                            component: '::div',
                                            // className: 'ttk-edf-app-portal-hor-header-right ,animated, slideInUp,',
                                            children: [{
                                                name: 'search',
                                                component: 'Input.Search',
                                                className: 'ttk-edf-app-portal-hor-header-right-search',
                                            ...
                                            name: 'help-title',
                                            component: '::ul',
                                            className: 'ttk-edf-app-portal-hor-header-right-help-subContent',
                                            children: [{
                                                name: 'content1',
                                                component: '::li',
                                                children: "{{'为什么修改密码后登录一直报错？'}}",
                                                className: 'ttk-edf-app-portal-hor-header-right-help-subContent-item'
                                            }, {
                                                name: 'content2',
                                                component: '::li',
                                ...
                                content: {
                                    ...
                                    children: [{
                                        ...
                                        component: 'Menu.Item',
                                        key: 'mySetting',
                                        className: 'ttk-edf-app-portal-hor-header-right-self-popover-item',
                                        children: [{
                                            name: 'message',
                                            component: 'Icon',
                                            fontFamily: 'edficon',
                                            style: { fontSize: '22px', verticalAlign: 'middle' },
                                            className: 'ttk-edf-app-portal-hor-header-right-self-popover-item1',
                                            type: 'gerenshezhi',
                                        }, {
                                            name: 'title',
                                            component: '::p',
                                            children: "{{'推荐的文章'}}",
                                            className: 'ttk-edf-app-portal-hor-header-right-help-title'
                                        }, {
                                            name: 'help-title',
                                            component: '::ul',
                                            className: 'ttk-edf-app-portal-hor-header-right-help-subContent',
                                ...
                                content: {
                                    ...
                                    children: [{
                                        ...
                                        children: [{
                                            ...
                                            component: 'Icon',
                                            style: { fontSize: '24px', verticalAlign: 'middle' },
                                            className: 'ttk-edf-app-portal-hor-header-right-self-popover-item2',
                                            type: 'zaixianbangzhuxin',
                                        }, {
                                            name: 'messageName',
                                            component: '::span',
                                        ...
                                        children: [{
                                            ...
                                            children: [{
                                                ...
                                                children: [{
                                                    ...
                                                    className: 'ttk-edf-app-portal-hor-header-right-self-popover-item-toggleColor',
                ...
                name: 'content',
                component: 'Layout',
                className: 'ttk-edf-app-portal-hor-content',
                // componentDidMount: '{{$resize()}}',
                trigger: 'click',
                children: [{
                    name: 'layContent',
                    className: "{{data.isTabsStyle ?'':'ttk-edf-app-portal-hor-content-noTabMarginStyle'}}",
                    component: 'Layout',
                    children: [{
                        name: 'tabs',
                        component: 'Tabs',
                        className: "{{data.openTabs.length >= 2 ? 'showLast ttk-edf-app-portal-hor-content-tabs  ': 'hideLast ttk-edf-app-portal-hor-content-tabs'}}",
                        ...
                        name: 'main',
                        component: 'Layout',
                        className: 'ttk-edf-app-portal-hor-content-main',
                ...
                name: 'panel',
                className: 'ttk-edf-app-portal-hor-content-configPanel',
                component: '::div',
                style: { display: "{{data.showControlPanel}}" },
                children: [{
                    name: 'shade',
                    className: 'ttk-edf-app-portal-hor-content-configPanel-shade',
                    component: '::div',
                    onClick: '{{function(){$hideCtrlPanel("cancel")}}}'
                }, {
                    name: 'container',
                    component: '::div',
                    className: '{{data.panelAnimation == "in" ? "ttk-edf-app-portal-hor-content-configPanel-container animated slideInRight" : "ttk-edf-app-portal-hor-content-configPanel-container animated slideOutRight"}}',
                    onAnimationEnd: "{{$hidePanelEnd}}",
                    children: [{
                        name: 'title',
                        component: '::div',
                        className: 'ttk-edf-app-portal-hor-content-configPanel-title',
                        children: [{
                            name: 'icon',
                            component: 'Icon',
                            fontFamily: 'edficon',
                        ...
                        name: 'main',
                        className: 'ttk-edf-app-portal-hor-content-configPanel-main',
                        component: '::div',
                        children: [{
                            name: 'gl',
                            component: '::div',
                            children: [{
                                name: 'options',
                                className: 'ttk-edf-app-portal-hor-content-configPanel-main-options',
                                component: 'AppLoader',
                        ...
                        name: 'btns',
                        className: 'ttk-edf-app-portal-hor-content-configPanel-btns',
                        component: '::div',
