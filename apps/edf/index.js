import ttk_edf_app_card_account from './ttk-edf-app-card-account'
import ttk_edf_app_card_currency from './ttk-edf-app-card-currency'
import ttk_edf_app_card_customer from './ttk-edf-app-card-customer'
import ttk_edf_app_card_department from './ttk-edf-app-card-department'
import ttk_edf_app_card_inventory from './ttk-edf-app-card-inventory'
import ttk_edf_app_card_project from './ttk-edf-app-card-project'
import ttk_edf_app_card_supplier from './ttk-edf-app-card-supplier'
import ttk_edf_app_card_userdefinecard from './ttk-edf-app-card-userdefinecard'
import ttk_edf_app_column from './ttk-edf-app-column'
import edfx_app_column_detail from './ttk-edf-app-column/apps/edfx-app-column-detail'
import edfx_app_column_setting from './ttk-edf-app-column/apps/edfx-app-column-setting'
...
import ttk_edf_app_forgot_password from './ttk-edf-app-forgot-password'
import ttk_edf_app_home from './ttk-edf-app-home'
import ttk_edf_app_hot_search_widget from './ttk-edf-app-home/apps/ttk-edf-app-hot-search-widget'
import ttk_edf_app_market_widget from './ttk-edf-app-home/apps/ttk-edf-app-market-widget'
import ttk_edf_app_sale_proportion_widget from './ttk-edf-app-home/apps/ttk-edf-app-sale-proportion-widget'
import ttk_edf_app_sale_trend_widget from './ttk-edf-app-home/apps/ttk-edf-app-sale-trend-widget'
import ttk_edf_app_sale_widget from './ttk-edf-app-home/apps/ttk-edf-app-sale-widget'
import ttk_edf_app_trade_widget from './ttk-edf-app-home/apps/ttk-edf-app-trade-widget'
import ttk_edf_app_visit_widget from './ttk-edf-app-home/apps/ttk-edf-app-visit-widget'
import ttk_edf_app_hotloader from './ttk-edf-app-hotloader'
import ttk_edf_app_iframe from './ttk-edf-app-iframe'
import ttk_edf_app_im from './ttk-edf-app-im'
import ttk_edf_app_login from './ttk-edf-app-login'
import ttk_edf_app_my_setting from './ttk-edf-app-my-setting'
import ttk_edf_app_my_setting_change_mobile from './ttk-edf-app-my-setting/apps/ttk-edf-app-my-setting-change-mobile'
import ttk_edf_app_my_setting_change_password from './ttk-edf-app-my-setting/apps/ttk-edf-app-my-setting-change-password'
import ttk_edf_app_notice from './ttk-edf-app-notice'
import ttk_edf_app_operation from './ttk-edf-app-operation'
import ttk_edf_app_pagestyle from './ttk-edf-app-pagestyle'
import ttk_edf_app_portal from './ttk-edf-app-portal'
import ttk_edf_app_portal_menu from './ttk-edf-app-portal-menu'
import ttk_edf_app_portal_menu_detail from './ttk-edf-app-portal-menu-detail'
import ttk_edf_app_register from './ttk-edf-app-register'
import ttk_edf_app_agreement from './ttk-edf-app-register/apps/ttk-edf-app-agreement'
import ttk_edf_app_role from './ttk-edf-app-role'
import ttk_edf_app_role_auth from './ttk-edf-app-role-auth'
import ttk_edf_app_root from './ttk-edf-app-root'
import simplelogin from './ttk-edf-app-simple-login'
import ttk_edf_app_simple_portal from './ttk-edf-app-simple-portal'
...
const obj = {
    ...
    [ttk_edf_app_simple_portal.name]: ttk_edf_app_simple_portal,
