...
plugins.push(new HtmlWebpackPlugin({
    ...
    template: './webpacksingle/index.html', //html模板路径
...
module.exports = {
    devtool: false,
    entry: {
        edf: ["edf-app-loader", "edf-meta-engine", "edf-component", "edf-consts", "edf-utils", "webapi", "singleGlobal", "./index.js"],
    ...
    resolve: {
        ...
        alias: Object.assign({
            ...
            'singleGlobal': path.resolve(projectRootPath, './global/global.js'),
