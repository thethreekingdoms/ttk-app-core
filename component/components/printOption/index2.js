            ...
            <div className="printOption2">
                <div className="printOption2-contaienr">
                    ...
                    <div style={{ padding: '5px 20px' }} className="printOption2-checkbox">
                        ...
                        {
                            this.props.exportType != 'sumaccount'?
                        ...
                        {
                            this.props.exportType != 'sumaccount' && this.props.type == '导出'?
                ...
                <div className="printOption2-bottom" style={{ textAlign: 'right', marginTop: '20px', paddingRight: '12px', fontSize:'12px' ,paddingTop:'12px'}}>
